...
function formatOutput(output: Output) {
  formattedOutput.savingRate =
    output.savingRate > 0
      ? addThousandSeparator(props.output.savingRate, props.seperator)
      : addThousandSeparator(props.output.savingRate * -1, props.seperator);
  formattedOutput.capitalAmount = addThousandSeparator(
    output.capitalAmount,
    props.seperator,
  );
  formattedOutput.startInvestment = addThousandSeparator(
    output.startInvestment,
    props.seperator,
  );
...
<template>
  <div class="mx-2">
    <h4 class="flex justify-center pt-5 pb-3 text-lg font-bold">
      {{ $t("answersentence.headline") }}
    </h4>
    <div class="bg-gray-200 py-5 rounded-lg px-2">
      <!-- answer sentences for saving plan -->
      <div v-if="scenario == 'saving'">
        <div v-if="isActive[0]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline">
            {{ $t("answersentence.savingplan.saving-rate-2") }}
            {{ formattedOutput.savingRate }} {{ currency }}
            {{ $t("answersentence.savingplan.saving-rate-3") }}</span
          >.
        </div>
        ...
        <div v-if="isActive[1]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline">
            {{ $t("answersentence.savingplan.interest-rate-2") }}
            {{ formattedOutput.interestRate }}%
            {{ $t("answersentence.savingplan.interest-rate-3") }}</span
          >.
        </div>
        ...
        <div v-if="isActive[2]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline">
            {{ $t("answersentence.savingplan.saving-start-value-2") }}
            {{ formattedOutput.startInvestment }} {{ currency }}
            {{ $t("answersentence.savingplan.saving-start-value-3") }}</span
          >.
        </div>
        ...
        <div v-if="isActive[3]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline">
            {{ $t("answersentence.savingplan.end-date-2") }} {{ years }}
            {{ $t("answersentence.savingplan.end-date-3") }}</span
          >
          ({{ formattedOutput.end }})
          <span class="font-weight-bold">
            {{ $t("answersentence.savingplan.end-date-4") }}</span
          >.
        </div>
        ...
        <div v-if="isActive[4]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline">
            {{ $t("answersentence.savingplan.capital-2") }}
            {{ formattedOutput.capitalAmount }} {{ currency }}</span
          >.
        </div>
      </div>

      <!-- answer sentences for withdrawal plan -->
      <div v-if="scenario == 'withdraw'">
        <div v-if="isActive[0]" class="text-center">
          {{ $t("answersentence.withdrawplan.saving-rate-1") }}<br />
          <span class="font-weight-bold text-decoration-underline">
            {{ $t("answersentence.withdrawplan.saving-rate-2") }}
            {{ formattedOutput.savingRate }} {{ currency }}
            {{ $t("answersentence.withdrawplan.saving-rate-3") }}</span
          >.
        </div>
        ...
        <div v-if="isActive[1]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline">
            {{ $t("answersentence.withdrawplan.interest-rate-2") }}
            {{ formattedOutput.interestRate }}%
            {{ $t("answersentence.withdrawplan.interest-rate-3") }}</span
          >.
        </div>
        ...
        <div v-if="isActive[2]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline">
            {{ $t("answersentence.withdrawplan.saving-start-value-2") }}
            {{ formattedOutput.startInvestment }} {{ currency }}
            {{ $t("answersentence.withdrawplan.saving-start-value-3") }}</span
          >.
        </div>
        ...
        <div v-if="isActive[3]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline">
            {{ $t("answersentence.withdrawplan.end-date-2") }} {{ years }}
            {{ $t("answersentence.withdrawplan.end-date-3") }}</span
          >
          ({{ formattedOutput.end }})
          <span class="font-weight-bold">
            {{ $t("answersentence.withdrawplan.end-date-4") }}</span
          >.
        </div>
        ...
        <div v-if="isActive[4]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline">
            {{ $t("answersentence.withdrawplan.capital-2") }}
            {{ formattedOutput.capitalAmount }} {{ currency }}</span
          >.
        </div>
      </div>
