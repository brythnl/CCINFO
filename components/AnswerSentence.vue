...
<template>
  <div class="mx-2">
    <h4 class="flex justify-center pt-5 pb-3 text-lg font-bold">{{ $t('answersentence.headline') }}</h4>
      ...
      <div v-if="scenario == 'saving'">
        ...
        <div v-if="isActive[1]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline"> {{
            ...
            }} {{ formattedOutput.interestRate }}% {{ $t('answersentence.savingplan.interest-rate-3') }}</span>.
        </div>
        ...
        <div v-if="isActive[2]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline"> {{
            ...
            }} {{ formattedOutput.startInvestment }} {{
              currency
        ...
        <div v-if="isActive[3]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline"> {{ $t('answersentence.savingplan.end-date-2') }} {{
              years
            }} {{ $t('answersentence.savingplan.end-date-3') }}</span> ({{ formattedOutput.end }}) <span
            class="font-weight-bold"> {{ $t('answersentence.savingplan.end-date-4') }}</span>.
        </div>
      ...
      <div v-if="scenario =='withdraw'">
        <div v-if="isActive[0]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline"> {{
              ...
              $t('answersentence.withdrawplan.saving-rate-3')
            }}</span>.
        </div>
        ...
        <div v-if="isActive[1]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline"> {{
            ...
            }} {{ formattedOutput.interestRate }}% {{ $t('answersentence.withdrawplan.interest-rate-3') }}</span>.
        </div>
        ...
        <div v-if="isActive[3]" class="text-center">
          ...
          <span class="font-weight-bold text-decoration-underline"> {{ $t('answersentence.withdrawplan.end-date-2') }} {{
              years
            }} {{ $t('answersentence.withdrawplan.end-date-3') }}</span> ({{ formattedOutput.end }}) <span
            class="font-weight-bold"> {{ $t('answersentence.withdrawplan.end-date-4') }}</span>.
        </div>
